...
from transformers import BioGptTokenizer, PreTrainedTokenizer
...
class TritonPythonModel:
	...
	def execute(self, requests) -> "List[List[pb_utils.Tensor]]":
		...
		for request in requests:
			...
			sequences_output = pb_utils.get_input_tensor_by_name(request, "sequences")
			...
			response = pb_utils.Tensor("sequences_text", text_array)
